function Footer() {
    return (
        <div className="flex gap-5 w-full h-screen bg-[#f1f1f1] p-20  text-black">
            ...
            <div className="w-1/2">
                ...
                <div className="heading-social text-3xl font-semibold mt-20"> S.
                    <div className="socialMedia font-['Neue_Montreal'] ">
                        <a className="block text-lg font-thin" href="https://www.linkedin.com/">Linkdin</a>
                        <a className="block text-lg font-light" href="https://www.instagram.com/">Instagram</a>
                        <a className="block text-lg font-light" href="https://www.example.com/">X</a>
                        <a className="block text-lg font-light" href="https://www.facebook.com/">Facebook</a>
                    </div>
                </div>
                <div className="heading-social text-3xl font-semibold mt-20"> M.
                    <div className="socialMedia font-['Neue_Montreal'] block text-lg font-thin">
                        <span>202-1965 W 4th Ave
                            <br />
                            Vancouver, Canada</span>
                    </div>
                    <div className="mt-10 font-['Neue_Montreal'] block text-lg font-thin" >
                        <span>
                            30 Chukarina St
                            <br />
                            Lviv, Ukraine
                ...
                <div className="heading-social text-3xl font-semibold mt-20"> E.
                    <div className="socialMedia font-['Neue_Montreal'] block text-lg font-thin">
                        <span>
                        hello@ochi.design
                        </span>
