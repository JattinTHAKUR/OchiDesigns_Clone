...
function Navbar() {
    ...
    return (
        <div className='fixed z-[999] w-full px-4 sm:px-8 py-4 font-["Neue Montreal"] flex justify-between items-center'>
            <div className="logo">
            ...
            <div className="links hidden sm:flex gap-4">
                <a className="text-lg capitalize font-light" href='#'>Services</a>
                <a className="text-lg capitalize font-light" href='#'>Our Work</a>
                <a className="text-lg capitalize font-light" href='#'>About Us</a>
                <a className="text-lg capitalize font-light" href='#'>Insights</a>
                <a className="text-lg capitalize font-light" href='#'>Contact Us</a>
            </div>
            ...
            {isMenuOpen && (
                <div className="sm:hidden absolute top-16 right-0 bg-zinc-900 w-full shadow-md">
                    <div className="px-4 py-2">
                        <a className="block py-2  text-white hover:text-gray-800">Services</a>
                        <a className="block py-2  text-white hover:text-gray-800">Our Work</a>
                        <a className="block py-2  text-white hover:text-gray-800">About Us</a>
                        <a className="block py-2  text-white hover:text-gray-800">Insights</a>
                        <a className="block py-2  text-white hover:text-gray-800">Contact Us</a>
                    </div>
                </div>
            )}
        </div>
